...
setting = 'Exchange_96_96_iTransformer_custom_M_ft96_sl48_ll96_pl128_dm8_nh2_el1_dl128_df1_fctimeF_ebTrue_dtExp_projection_0'
result_path = f'./results/{setting}/'
...
ax.set_ylim(np.min(trues[:, :, channel]) , np.max(trues[:, :, channel])  )
