...
try:
    ...
    data_type = 'CMAPSS'  # 예시: 'Appliances', 'Exchange', 'ECL'
    base_path = './results/train_FD001_24_96_iTransformer_CMAPSS_M_ft24_sl48_ll96_pl512_dm8_nh3_el1_dl512_df1_fctimeF_ebTrue_dtExp_projection_0/'
    ...
    start_frame = 0
    num_frames_to_render = 65  # 원본 코드와 동일하게 800개 프레임을 렌더링
